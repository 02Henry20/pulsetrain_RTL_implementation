...
set PARASITIC_PATHS "../../../StarRC/min/results"
...
######################################
set CONSTRAINT_FILES     "../../../PNR/SS/pnr/outputs_icc2/TOP_PREV_mode_norm.OC_rvt_ff_min_1p100v_m40c.RC_MIN.sdc"  
...
# GRD file
set TCAD_GRD_FILE(0) "/data/S28/tech/starrc/CELL_LEVEL/LN28LPP_StarRC_Cell_S00-V1.1.0.1_SEC2.0.6.0/tcad/7U1x_2T8x_LB/ln28lpp_7U1x_2T8x_LB_SigRCmin_detailed.nxtgrd"

# Additional info. Ex temperature, voltage
set STARRC_ADDITIONAL(0) "mode_norm.OC_rvt_ff_min_1p100v_m40c.RC_MAX"
