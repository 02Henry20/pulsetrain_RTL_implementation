...
#}
#
read_parasitics -format SPEF -verbose ../../../StarRC/max/results/RC_MAX.spef
...
##################################################################
save_session ${DESIGN_NAME}_ss_timing
...
##################################################################
report_global_timing > $REPORTS_DIR/timing/01_report_global_timing
report_clock -skew -attribute > $REPORTS_DIR/timing/02_report_clock
report_analysis_coverage > $REPORTS_DIR/timing/03_report_analysis_coverage
report_timing -slack_lesser_than 0.0 -delay min_max -nosplit -input -net  > $REPORTS_DIR/timing/04_report_timing
...
# smkcow :: below is REAL
#set_app_var eco_alternative_area_ratio_threshold "5"
#fix_eco_timing -type hold -verbose -slack_lesser_than 0 -buffer_list {\
BUF_X0P7B_A9TR \
BUF_X0P7M_A9TR \
BUF_X0P8B_A9TR \
BUF_X1B_A9TR \
...
write_sdf $RESULTS_DIR/TOP_PREV_max.sdf_PT
