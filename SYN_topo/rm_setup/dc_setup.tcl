...
# smkcow : fifo.v and memory_wrapper.v are not here
# smkcow : Because we will read_ddc after reading these files
# Just skip the first link error 
set RTL_SOURCE_FILES   "/data/SCRIPTS/COMMON_VERILOG/DEMUX.v \
