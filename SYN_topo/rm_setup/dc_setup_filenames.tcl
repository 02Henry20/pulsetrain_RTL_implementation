...
set DCRM_MCMM_SCENARIOS_SETUP_FILE                      TOP.mcmm.scenarios.tcl
...
set DCRM_SDC_INPUT_FILE                                 ${DESIGN_NAME}.mapped.sdc
set DCRM_CONSTRAINTS_INPUT_FILE                         TOP.constraints.tcl
