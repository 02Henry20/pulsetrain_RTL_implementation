...
if {$USE_RM_BLOCK_NAME_AS_LABEL} {
	...
	copy_block -from ${ROUTE_OPT_BLOCK_NAME} -to ${CHIP_FINISH_BLOCK_NAME}
...
redirect -file ${REPORTS_DIR}/${CHIP_FINISH_BLOCK_NAME}.report_lib_cell_purpose.rpt {report_lib_cell -objects [get_lib_cells] -column {full_name:20 valid_purposes}}
...
# smkcow
# remove_cells [get_cells xofiller*]
...
if {$DESIGN_STYLE == "hier"} {
        ...
        if {$USE_RM_BLOCK_NAME_AS_LABEL} {
           ...
           derive_hier_antenna_property -design ${CHIP_FINISH_BLOCK_NAME}
        }
}
###############
...
redirect -file ${REPORTS_DIR}/${REPORT_PREFIX}.report_design {report_design -netlist}
