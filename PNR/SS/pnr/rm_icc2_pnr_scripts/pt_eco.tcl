...
redirect -file ${REPORTS_DIR}/${PT_ECO_BLOCK_NAME}.report_lib_cell_purpose.rpt {report_lib_cell -objects [get_lib_cells] -column {full_name:20 valid_purposes}}
...
if {$PT_ECO_MODE == "freeze_silicon"} {
	...
	## Add and place spare cells
	add_spare_cells -cell_name $PT_ECO_SPARE_CELL_PREFIX -num_cells $PT_ECO_SPARE_CELL_REF_NUM_LIST
	place_eco_cells -legalize_only -cells [get_cells -physical_context *${PT_ECO_SPARE_CELL_PREFIX}*]
