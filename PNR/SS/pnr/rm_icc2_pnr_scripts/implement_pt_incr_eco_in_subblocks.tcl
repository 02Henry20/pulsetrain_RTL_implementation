...
if {$USE_RM_BLOCK_NAME_AS_LABEL} {
        ...
        copy_block -from ${block_refname} -to ${PT_ECO_INCREMENTAL_2_BLOCK_NAME}
        current_block ${PT_ECO_INCREMENTAL_2_BLOCK_NAME}
}
...
source -e ../${block_refname_no_label}/rm_icc2_pnr_scripts/settings.common.non_persistent.tcl
