...
#smkcow :: no pg 
read_verilog -i ${OUTPUTS_DIR}/${WRITE_DATA_BLOCK_NAME}.v.gz
...
set_constant -type port r:/WORK/${DESIGN_NAME}/pad*/SNS 1
set_constant -type port i:/WORK/${DESIGN_NAME}/pad*/SNS 1

set_constant -type port r:/WORK/${DESIGN_NAME}/pad*/RTO 1
set_constant -type port i:/WORK/${DESIGN_NAME}/pad*/RTO 1
